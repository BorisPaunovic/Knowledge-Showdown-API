...
SELECT cat_id,cat_name,cat_description,cat_is_deleted,concat('${getCategory}/',cat_id)AS cat_img
FROM categories 
WHERE cat_is_deleted IS NULL`

//vraca sve kategorije koje nisu izbrisane
